...
namespace Pulse.DirectX
{
    ...
    public enum DdsPixelFormatFlags
    {
        ...
        /// <summary>
        /// Used in some older DDS files for single channel color uncompressed data (dwRGBBitCount contains the luminance channel bit count; dwRBitMask contains the channel mask). Can be combined with ALPHAPIXELS for a two channel DDS file.
        /// </summary>
        Luminance = 0x20000
    }
}