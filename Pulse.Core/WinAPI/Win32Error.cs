namespace Pulse.Core.WinAPI
{
    public enum Win32Error
    {
        ...
        /// <summary>eached the end of the file.</summary>
        ...
        /// <summary>The Security Accounts Manager (SAM) database on a Windows Server is significantly out of synchronization with the copy on the domain controller. A complete synchronization is required.</summary>
        ...
        /// <summary>{Delayed Write Failed} Windows was unable to save all the data for the file %hs. The data has been lost. This error may be caused by a failure of your computer hardware or network connection. Try to save this file elsewhere.</summary>
        ERROR_LOST_WRITEBEHIND_DATA = 0x00000254,

        /// <summary>The parameters passed to the server in the client/server shared memory window were invalid. Too much data may have been put in the shared memory window.</summary>
        ...
        /// <summary>{Invalid DLL Entrypoint} The dynamic link library %hs is not written correctly. The stack pointer has been left in an inconsistent state. The entry point should be declared as WINAPI or STDCALL. Select YES to fail the DLL load. Select NO to continue execution. Selecting NO may cause the application to operate incorrectly.</summary>
        ERROR_BAD_DLL_ENTRYPOINT = 0x00000261,

        /// <summary>{Invalid Service Callback Entrypoint} The %hs service is not written correctly. The stack pointer has been left in an inconsistent state. The callback entry point should be declared as WINAPI or STDCALL. Selecting OK will cause the service to continue operation. However, the service process may operate incorrectly.</summary>
        ...
        /// <summary>The device encountered an error while applying power or reading the device configuration. This may be caused by a failure of your hardware or by a poor connection.</summary>
        ...
        /// <summary>This warning level status indicates that the transaction state already exists for the registry subtree, but that a transaction commit was previously aborted. The commit has NOT been completed, but it has not been rolled back either (so it may still be committed if desired).</summary>
        ...
        /// <summary>{GUID Substitution} During the translation of a GUID to a Windows SID, no administratively defined GUID prefix was found. A substitute prefix was used, which will not compromise system security. However, this may provide more restrictive access than intended.</summary>
        ...
        /// <summary>{Delayed Write Failed} Windows was unable to save all the data for the file %hs; the data has been lost. This error may be caused by network connectivity issues. Try to save this file elsewhere.</summary>
        ...
        /// <summary>ecursion too deep; the stack overflowed.</summary>
        ...
        /// <summary>Indicates a particular SID may not be assigned as the label of an object.</summary>
        ...
        /// <summary>This SID may not be assigned as the owner of this object.</summary>
        ERROR_INVALID_OWNER = 0x0000051B,

        /// <summary>This SID may not be assigned as the primary group of an object.</summary>
        ...
        /// <summary>ecord field does not exist.</summary>
        ...
        PC_S_CALL_IN_PROGRESS = 0x000006FF,
        ...
        PC_S_NO_MORE_BINDINGS = 0x0000070E,
        ...
        PC_S_INVALID_OBJECT = 0x0000076C,
        ...
        /// <summary>emote connections to the Print Spooler are blocked by a policy set on your machine.</summary>
        ...
        /// <summary>equested addition of items exceeds the maximum allowed.</summary>
        ...
        /// <summary>emote boot will be restarted later.</summary>
        ...
        /// <summary>emote boot service was stopped, check the error log for the cause of the problem.</summary>
        NERR_RplBootServiceTerm = 0x000009D5,

        /// <summary>emote boot startup failed; check the error log for the cause of the problem.</summary>
        ...
        /// <summary>eissue the given operation as a cached I/O operation.</summary>
        ...
        /// <summary>eplication with a nonconfigured partner is not allowed.</summary>
        ...
        /// <summary>This operation cannot be performed on the cluster resource because it is the quorum resource. You may not bring the quorum resource offline or modify its possible owners list.</summary>
        ...
        /// <summary>ecovery policy configured for this system contains invalid recovery certificate.</summary>
        ...
        /// <summary>ecords were appended to the log or reservation changes were made, but the log could not be flushed.</summary>
        ...
        /// <summary>This file is open for modification in an unresolved transaction and may be opened for execution only by a transacted reader.</summary>
        ...
        /// <summary>econnecting a disconnected session to the console is not supported.</summary>
        ...
        /// <summary>emote control could not be terminated because the specified session is not currently being remotely controlled.</summary>
        ...
        /// <summary>emote logons are currently disabled.</summary>
        ...
        /// <summary>The file replication service cannot populate the system volume because of an internal time-out. The event log may have more information.</summary>
        ...
        /// <summary>eplication access was denied.</summary>
        ...
        /// <summary>The directory cannot validate the proposed naming context name because it does not hold a replica of the naming context above the proposed naming context. Ensure that the domain naming master role is held by a server that is configured as a GC server, and that the server is up-to-date with its replication partners. (Applies only to Windows 2000 domain naming masters.)</summary>
        ...
        /// <summary>The source domain may not be in the same forest as the destination.</summary>
        ...
        ///<summary>Critical directory service system objects cannot be deleted during tree deletion operations. The tree deletion may have been partially performed.</summary>
        ...
        /// <summary>ename or move operations on naming context heads or read-only objects are not allowed.</summary>
        ...
        /// <summary>Insufficient attributes were given to create an object. This object may not exist because it may have been deleted and the garbage already collected.</summary>
        ...
        /// <summary>ecord for given name and type is not unique.</summary>
        ...
        /// <summary>ecord is only at DNS zone root.</summary>
        ...
        /// <summary>an out of quota.</summary>
        WSAEUSERS = 0x00002754,

        /// <summary>an out of disk quota.</summary>
        ...
        /// <summary>eturned by WSARecv or WSARecvFrom to indicate that the remote party has initiated a graceful shutdown sequence.</summary>
        ...
        /// <summary>eserve has been confirmed.</summary>
        ...
        /// <summary>eached maximum quick mode limit for the main mode. New main mode will be started.</summary>
        ...
        /// <summary>eceived unexpected message ID.</summary>
        ERROR_IPSEC_IKE_UNEXPECTED_MESSAGE_ID = 0x00003640,

        /// <summary>eceived invalid AuthIP user mode attributes.</summary>
        ...
        /// <summary>The identity string is malformed. This may be due to a trailing comma, more than two unnamed attributes, a missing attribute name, or a missing attribute value.</summary>
        ...
        /// <summary>The query result is stale or invalid. This may be due to the log being cleared or rolling over after the query result was created. Users should handle this code by releasing the query result object and reissuing the query.</summary>
        ...
        /// <summary>egistered Microsoft XML (MSXML) does not support validation.</summary>
